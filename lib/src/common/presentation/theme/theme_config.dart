...
ThemeData lightTheme = ThemeData(
  ...
  checkboxTheme: CheckboxThemeData(fillColor: MaterialStatePropertyAll(_ligthScheme.primary)),
);
...
ThemeData darkTheme = ThemeData(
  ...
  checkboxTheme: CheckboxThemeData(fillColor: MaterialStatePropertyAll(_darkScheme.primary)),
);
